...
function Dashboard({ user, onLogout }) {
  ...
  return <div className={dark ? "app" : "app light"}>
    <aside className="sidebar">
      <div className="brand"><div className="brand-mark">L</div><span>Lumyn<span className="accent">TCG</span></span></div>
